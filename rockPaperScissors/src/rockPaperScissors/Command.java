...
public class Command{
    ...
    private static final String[] validMoves = {"SCISSORS", "PAPER", "ROCK", "LIZARD","SPOCK"};
    ...
    public Move newRandomMove(){
	    ...
	    return new Move (validMoves[ (int) (p * validMoves.length)]);
    }
    ...
    public static int checkWinner(String first, String second){
	    ...
	    System.out.println((first_i +3) % validMoves.length);
	    return ((((first_i +1) % validMoves.length ) == second_i )||(((first_i +3) % validMoves.length ) == second_i ))? WIN: LOSE;
	}
